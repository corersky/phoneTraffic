...
//创建菜单
$button1=array("type"=>"view","url"=>"http://duanxin.xzkj168.cn/weixin/sendliuliang.php","name"=>urlencode("点击充值"));
$button2=array("type"=>"view","url"=>"http://duanxin.xzkj168.cn/weixin/myinfo.php","name"=>urlencode("关于我们"));

$sub_button1=array("type"=>"view","url"=>"http://duanxin.xzkj168.cn/weixin/g1.php","name"=>urlencode("功能1"));
