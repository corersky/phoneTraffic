...
function getaccessToken(){
	$a=get_url_contentshttps("https://open.mengdian.com/common/token?grant_type=client_credential&appid=b0e93692643c63f07ef12411f57a68e4&secret=82059c497589bbe3d72334e2d3174980");
...
function orderGetHighly($access_token){
	...
	$url="https://open.mengdian.com/api/mname/WE_MALL/cname/orderGetHighly?accesstoken=".$access_token;
	$data=array(
		"order_type"=>"",
		"order_source"=>"",
		"order_status"=>1,
...
function orderFullInfoGetHighly($access_token,$order_no){
	...
	$update_end_time=date("Y-m-d H:i:s");
	$update_begin_time=date("Y-m-d H:i:s",(time()-60*60*3));
	$url="https://open.mengdian.com/api/mname/WE_MALL/cname/orderFullInfoGetHighly?accesstoken=".$access_token;
	$data=array(
		"order_no"=>$order_no
	);
...
function spuFullInfoGet ($access_token){
	...
	$update_end_time=date("Y-m-d H:i:s");
	$update_begin_time=date("Y-m-d H:i:s",(time()-60*60*3));
	$url="https://open.mengdian.com/api/mname/WE_MALL/cname/spuFullInfoGet?accesstoken=".$access_token;
	$data=array(
		"is_onsale"=>2,
		"page_no"=>1,
		"page_size"=>100
...
function logisticsDelivery($access_token,$order_no){
	...
	$url="https://open.mengdian.com/api/mname/WE_MALL/cname/logisticsDelivery?accesstoken=".$access_token;
	$data=array(
		"order_no"=>$order_no,
		"need_delivery"=>"false",
		"carrier_code"=>"ems",
