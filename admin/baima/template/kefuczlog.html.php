...
margin-left:10px;">
                                    ...
                                    <div class="fl">
                                    	<select name="" class="inputtext2" id="cztype" onchange="soso()">
											...
											<option value="500" <!--{if $cztype==500}-->selected="selected"<!--{/if}-->>修改价格</option>
											<option value="1" <!--{if $cztype==1}-->selected="selected"<!--{/if}-->>充值</option>
											<option value="2" <!--{if $cztype==2}-->selected="selected"<!--{/if}-->>新增代理</option>
                                        </select>
                                    </div>
                                </div>
                                <div style="font-size:15px; font-family:'微软雅黑'; font-weight:bold; margin-top:6px; 
...
margin-left:10px;">
                                    ...
                                    <div class="fl">
                                    	<select name="" class="inputtext2" id="czuid" onchange="soso()">
											...
											<!--{loop $fuwuzyarr $key=>$value}-->
											<option value="{$key}" <!--{if $cztype==$key}-->selected="selected"<!--{/if}-->>{$value}</option>
											<!--{/loop}-->
                                        </select>
                                    </div>
                                </div>
