...
color:#363636;"><div>结算状态</div></span>
                            </li>
                            ...
                            <li>
                                ...
                                <span class="list4 mt" onClick="showtuijianinfo('{$value[id]}');document.getElementById('showtuijian').style.display=''">推荐详情</span>
<!--{if empty($value['zt'])}-->
<span class="list5 mt"><span style="color:#06F; cursor:pointer;" onClick="sendjiesuanjine('{$value[dlnick]}','{$value[jine]}','{$value[yuefen]}','{$value[id]}');document.getElementById('showjiesuan').style.display=''">未结算</span>
<!--{else}-->		
<span class="list5 mt"><span style="color:#666; cursor:default;">已结算</span></span>
<!--{/if}-->	                         
                            </li>
							 <!--{/loop}-->
...
radius:3px;-webkit-border-radius:3px;-moz-border-radius:3px;">
                <div style="padding-top:5px; text-align:center;">推荐详情！</div>
            </div>
...
onClick="document.getElementById('showtuijian').style.display='none';">
            ...
            <div style="width:550px; height:480px; overflow:hidden; margin-top:10px; font-family:'微软雅黑'; font-

size:17px;">
                <iframe name="showck" id="showck" src="#" width="550" height="510" frameborder="0" scrolling="no" 

style="padding:5px 0px; margin-top:-11px;">短信服务平台使用了框架技术，但是您的浏览器不支持框架，请更换您的浏览器以便正常使
...
radius:3px;-webkit-border-radius:3px;-moz-border-radius:3px;">
                <div style="padding-top:5px; text-align:center;">请确认是否结算！</div>
            </div>
            ...
            <div style="width:530px; height:220px; overflow:hidden; margin-left:10px; margin-top:10px; font-family:'微软雅黑'; font-size:17px;">
                <div style="margin-left:50px; margin-top:20px;">
                	<div style="height:50px;">
                    	<div class="fl" style="width:100px;">代理商：</div>
                        <div class="fl" style="width:200px;" id="div_id_dlname">腾讯科技</div>
                    </div> 
                    <div style="height:50px;">
                    	<div class="fl" style="width:100px;">结算金额：</div>
                        <div class="fl" style="width:200px;" id="div_id_jine">200元</div>
                    </div>
                    <div style="height:50px;">
                    	<div class="fl" style="width:100px;">结算日期：</div>
                        <div class="fl" style="width:200px;" id="div_id_shijian">2015年8月</div>
                    </div>
