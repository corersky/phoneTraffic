...
#ddgldhlldd .inputtext3{width:60px;height:28px; border:#add1fe 1px solid; font-size:13px; color:#666; font-family:'微软雅黑'; font-weight:bold; outline:none; border-radius:3px;-webkit-border-radius:3px;-moz-border-radius:3px; cursor:pointer;}
                        ...
                        <ul>
                            ...
                            <li style="height:80px; background-color:#def0fe; border:#c0e3ff 1px solid; margin:-1px 0 0 -1px;">
                                    ...
                                    <div style="font-size:15px; font-family:'微软雅黑'; font-weight:bold; margin-top:6px; margin-left:10px;">
                                        ...
                                        <div class="fl">
                                            <select name="" class="inputtext2"  id="sosozt">
                                                ...
                                                <option value="3" <!--{if $zt==3}-->selected="selected"<!--{/if}-->>提交成功</option>
                                                <option value="1" <!--{if $zt==1}-->selected="selected"<!--{/if}-->>兑换成功</option>
                                                <option value="2" <!--{if $zt==2}-->selected="selected"<!--{/if}-->>兑换失败</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div style="font-size:15px; font-family:'微软雅黑'; font-weight:bold; margin-top:6px; margin-left:10px;">
                                        <div class="fl" style="margin-top:4px; margin-left:200px;">时间查询：</div>
                                        <div class="fl">
                                ...
                                <div style="height:40px;">
                                    ...
                                    <div style="height:40px;">
                                        <div style="font-size:15px; font-family:'微软雅黑'; font-weight:bold; margin-top:6px; margin-left:290px;">
                                            <div class="fl" style="margin-top:4px; margin-left:93px;">兑换总条数<span style="color:#F00; font-size:16px;"> {$duihuanzongnum}</span>条</div>
                                        </div>
                                        <div style="font-size:15px; font-family:'微软雅黑'; font-weight:bold; margin-top:6px; margin-left:10px;">
                                            <div class="fl" style="margin-top:4px; margin-left:10px;">兑换套餐面额总和：<span style="color:#F00; font-size:16px;"> {$mianzhizongnum}</span>元</div>
                                        </div>
                                    </div>
                                </div>
                            </li>
