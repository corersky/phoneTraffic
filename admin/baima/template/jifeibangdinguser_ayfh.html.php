...
<div id="jfgljfgl2ck2" style="float:left;width:550px; height:230px;">
            ...
            <div id="table">
                <ul>
                	...
                	<div style="position:absolute; margin-top:-27px; font-size:14px; color:#FFF; font-weight:bold;">
                        <span class="fl cp">
                        	<a href="index.php?action=jifeibangdinguser_zdxf&uid={$uid}">
                                <div>
                    ...
                    <li class="title">
                        ...
                        <span class="list2" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>返还条数</div></span>
                        <span class="list3" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>发放时间</div></span>
                        <span class="list4" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>发放状态</div></span>
                    </li>
	<!--{loop $userarr $value}-->
                    <li>
