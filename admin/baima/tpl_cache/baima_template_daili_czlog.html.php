                    ...
                    <div id="table">
                        <ul>
                            ...
                            <li class="title">
                                ...
                                <span class="list4" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>充值类型</div></span>
                            ...
                            <li>
                                ...
                                <span class="list4 mt">
<?php if(empty($value['cztype'])) { ?>
手动充值
<?php } elseif($value['cztype']==1) { ?>
手动扣费
