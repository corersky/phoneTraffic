                    ...
                    <div id="table">
                        <ul>
                            ...
                            <li class="title">
                                ...
                                <span class="list6" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>登录IP</div></span>
                                <span class="list7" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>备注</div></span>
                            </li>
...
<?php if(is_array($userarr)) { foreach($userarr as $value) { ?>
                            <li>
                                ...
                                <span class="list4 mt"><?=$yingxiaozyarr[$value['yingxiaoid']]?></span>
                                <span class="list5 mt"><?=$fuwuzyarr[$value['kefuid']]?></span>
<span class="list6 mt3"><div><?=$value['zhdlip']?></div><div><?=$value['zhdltime']?></div></span>
