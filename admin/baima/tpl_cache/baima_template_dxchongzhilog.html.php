...
<option value="-2" <?php if($czuid==-2) { ?>selected="selected"<?php } ?>>系统自动充值</option>

<?php if(is_array($fuwuzyarr)) { foreach($fuwuzyarr as $k=>$v) { ?>
                                            <option value="<?=$k?>" <?php if($czuid==$k) { ?>selected="selected"<?php } ?>><?=$v?></option>
                                            <?php } } ?>
                                        </select>
                                    </div>
                                </div>
                                <div style="font-size:15px; font-family:'微软雅黑'; font-weight:bold; padding-top:30px; margin-left:10px;">
                                    ...
                                    <div class="fl" style="margin-left:5px;">
                                    	<select name="" id="sosocztype" class="inputtext2">
                                            <option value="0">全部</option>
                                            <option value="-1" <?php if($cztype==-1) { ?>selected="selected"<?php } ?>>在线充值</option>
<option value="1" <?php if($cztype==1) { ?>selected="selected"<?php } ?>>手动充值</option>
<option value="2" <?php if($cztype==2) { ?>selected="selected"<?php } ?>>套餐按月返还</option>
<option value="3" <?php if($cztype==3) { ?>selected="selected"<?php } ?>>套餐最低消费达不到扣费</option>
<option value="4" <?php if($cztype==4) { ?>selected="selected"<?php } ?>>提交失败返还</option>
<option value="5" <?php if($cztype==5) { ?>selected="selected"<?php } ?>>手动扣费</option>
<option value="7" <?php if($cztype==7) { ?>selected="selected"<?php } ?>>发送失败退款</option>
                                        </select>
                                    </div>
                                </div>
