...
<?php if($value['shenheid']==-1) { ?>管理员<?php } else { ?><?=$fuwuzyarr[$value['shenheid']]?><?php } ?>
审失败<img src="baima/template/images/tjsbtips.png" width="16" height="16"></span>
<?php } else { ?>
<span style="color:#25ae00;"><?php if($value['shenheid']==-1) { ?>管理员<?php } else { ?><?=$fuwuzyarr[$value['shenheid']]?><?php } ?>审核成功</span>
<?php } ?>
