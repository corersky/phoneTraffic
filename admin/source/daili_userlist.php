...
$sosoyingxiaozyid=trim($_GET["sosoyingxiaozyid"]);
if(!empty($sosoyingxiaozyid)){
	$wherestr=$wherestr." and yingxiaoid=".$sosoyingxiaozyid;
}
/*
...
$url=XZKJURL."/index.php?action=daili_userlist&nick=".$nick."&sosoyingxiaozyid=".$sosoyingxiaozyid;
