...
<div id="mains">
	<div id="ddglycldd" style="margin-bottom:30px;">
        ...
        <div style="width:750px; height:40px; padding-left:10px; margin-top:10px; background-color:#eee; border-radius:8px;-webkit-border-radius:8px;-moz-border-radius:8px;">
            ...
            <div class="fl" style="margin-top:10px; margin-left:10px; font-family:'微软雅黑'; font-size:14px; color:#979797; font-weight:bold;">已处理订单</div>
        </div>
                    ...
                    <div id="table">
                        <ul>
                            ...
                            <li class="title">
                                ...
                                <span class="list5" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>扣费条数</div></span>
                                <span class="list6" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>号码个数</div></span>
                                <span class="list7" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>审核方式</div></span>
                                <span class="list8" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>订单明细</div></span>
                            </li>
                            ...
                            <li>
								...
								<!--{else}-->
									<!--{if $value['zt']==2}-->
									<span style="color:#de0000; cursor:pointer;" onClick="showordererrnei('{$value[msg]}');document.getElementById('showshbtgyy').style.display='';">人审失败<img src="baima/template/images/tjsbtips.png" width="16" height="16"></span>
									<!--{else}-->
									<span style="color:#25ae00;">人审核成功</span>
									<!--{/if}-->
...
<span id="showckddmx" class="showckddmx" style="display:none;">
	...
	<div style="position:fixed;top:50%;left:50%;z-index:10000;margin:0 auto;margin:-275px 0 0 -275px;width:550px;height:550px;border:2px solid #278ce4;box-shadow: 0px 0px 12px #278ce4;border-radius:7px;-webkit-border-radius:7px;-moz-border-radius:7px;background-color:#FFF;">
        <div style="width:550px;">
            <div style="height:40px; background-color:#278ce4; font-family:'微软雅黑'; font-size:22px; color:#FFF;border-radius:3px;-webkit-border-radius:3px;-moz-border-radius:3px;">
                <div style="padding-top:5px; text-align:center;"  id="div_showduanxinsendinfo_title">订单明细</div>
            </div>
