                    ...
                    <div id="table">
                        <ul>
                            ...
                            <li class="title">
                                ...
                                <span class="list4" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>审核操作</div></span>
                            </li>
                            ...
                            <li>
                                ...
                                <span class="list4 mt2" style="color:#006dcb;">
                                	<div><a href="{XZKJURL}/useration.php?action=tempshenheok&id={$value[id]}" target="hiddeniframe" style="color:#006dcb;">通过</a></div>
