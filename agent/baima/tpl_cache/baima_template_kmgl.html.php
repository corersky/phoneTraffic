...
<option value="0">全部</option>
                            <option value="1" <?php if($kazt==1) { ?>selected="selected"<?php } ?>>未充值卡密</option>
                            <option value="2" <?php if($kazt==2) { ?>selected="selected"<?php } ?>>已充值卡密</option>
                        </select>
                    </div>
...
<option value="0">全部</option>
                            <option value="1" <?php if($czzt==1) { ?>selected="selected"<?php } ?>>充值成功</option>
                            <option value="2" <?php if($czzt==2) { ?>selected="selected"<?php } ?>>充值失败</option>
                            <option value="3" <?php if($czzt==3) { ?>selected="selected"<?php } ?>>充值中</option>
                        </select>
                    </div>
