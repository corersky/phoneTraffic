<!--{template header}-->
<script>
function setuser(uid,username,sjh,lxrxm,lxrqq,gsmc,dizhi,qianming){
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="list4 mt" style="color:#006dcb;">
                                	<span class="cp" onClick="setuser('{$value[id]}','{$value[username]}','{$value[sjh]}','{$value[lxrxm]}','{$value[lxrqq]}','{$value[gsmc]}','{$value[dizhi]}','{$value[qianming]}');document.getElementById('showyhzl').style.display='';">查看</span>
                                </span>
