...
if($action=="adduser"){
	...
	$logmsg="添加代理商";
	insertcaozuolog($_SESSION["kefu_uid"],$tid,$_SESSION["kefu_username"],$username,2,$logmsg);
	...
	if($chongzhi_jine>0){
		...
		insertcaozuolog($_SESSION["kefu_uid"],$chongzhi_uid,$_SESSION["kefu_username"],$userinfo['username'],1,$logmsg);
...
//获取代理商信息
	...
	insertcaozuolog($_SESSION["kefu_uid"],$uid,$_SESSION["kefu_username"],$userinfo['username'],0,$logmsg);
