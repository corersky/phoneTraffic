...
<option value="12" <?php if($sosom==12) { ?>selected="selected"<?php } ?>>12</option>
    ...
    <div style="border-bottom:#d8d8d8 1px solid;">
                            	<div style="margin-top:10px; margin-left:20px; text-align:left; font-family:'微软雅黑'; font-size:15px; color:#333;">指定条数的总充值条数为：<?=$zongcongzhinum?> 。总消耗金额<?=$zengkoufeinum?>  。</div>
                            </div>
