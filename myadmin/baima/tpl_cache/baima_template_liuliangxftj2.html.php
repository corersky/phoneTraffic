...
<?php if(is_array($tongdaoarr)) { foreach($tongdaoarr as $value) { ?>
                                                <option value="<?=$value['id']?>" <?php if($tongdaiid==$value['id']) { ?>selected="selected"<?php } ?>><?=$value['title']?></option>
<?php } } ?>
...
<option value="1" <?php if($tjzt==1) { ?>selected="selected"<?php } ?>>失败未付款</option>
<option value="2" <?php if($tjzt==2) { ?>selected="selected"<?php } ?>>失败已返款</option>
                                        </select>
                                        </div>
                                    </div>
<div style="font-size:15px; font-family:'微软雅黑'; font-weight:bold; margin-top:6px; margin-left:5px;">
...
<option value="0">全部</option>
 <option value="-1" <?php if($yingxiaoid==-1) { ?>selected="selected"<?php } ?>>公司</option>
<?php if(is_array($yingxiaozyarr)) { foreach($yingxiaozyarr as $k=>$v) { ?>
<option value="<?=$k?>" <?php if($yingxiaoid==$k) { ?>selected="selected"<?php } ?>><?=$v?></option>
<?php } } ?>
