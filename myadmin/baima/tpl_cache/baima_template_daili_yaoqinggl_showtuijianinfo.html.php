...
<div id="dlsgltjjsck" style="float:left;width:550px; height:230px;">
    <div style="margin-top:20px; margin-left:20px;">
        <div style="font-size:13px; font-family:'微软雅黑'; font-weight:bold;">
            ...
            <div class="fl" style="margin-top:2px;">支付宝账号：</div>
            ...
            <div class="fl" style="margin-top:2px; margin-left:20px;">用户名：</div>
            ...
            <div id="table">
                <ul>
                    <li class="title">
                        ...
                        <span class="list4" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>充值金额</div></span>
                        <span class="list5" style="font-size:14px; font-weight:bold; cursor:default; height:20px; color:#363636;"><div>奖励金额</div></span>
                    </li>
<?php if(is_array($userarr)) { foreach($userarr as $value) { ?>
                    <li>
                        ...
                        <span class="list4 mt"><?=$value['chongzhijine']?>元</span>
                        <span class="list5 mt"><?=$value['jianglijine']?>元</span>
