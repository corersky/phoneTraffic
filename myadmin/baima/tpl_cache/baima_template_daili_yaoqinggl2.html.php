...
<?php if(is_array($yaoqingdailiuserarr)) { foreach($yaoqingdailiuserarr as $value) { ?>
                                             <option value="<?=$value['username']?>" <?php if($value['username']==$nick) { ?>--

>selected="selected"<!--<?php } ?>><?=$value['username']?></option>
 <?php } } ?>
                                        </select>
